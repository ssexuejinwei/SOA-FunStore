...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                .authorizeRequests()
                .antMatchers("/home", "/search","/registration","/css/**","/images/**","/js/**","/js/html5/**","/libraries/fonts/**","/libraries/**","/revolution/font.revicons/**","/revolution/assets/**","/revolution/css/**","/revolution/js/**","/style.css","/error", "/h2-console/**").permitAll()
